...
class TestMedicaPathologyImport(TransactionCase):
    ...
    def setUp(self):
        ...
        self.code_type = self.env.ref('medical_pathology.pathology_code_05')
    ...
    def test_get_importer_types(self):
        ...
        self.assertEqual(self.Model._get_importer_types(), [])
    ...
    def test_upsert_pathology_update(self):
        ...
        self.assertEqual(pathology.name, args['name'])
    ...
    def test_upsert_pathology_category_update(self):
        ...
        self.assertEqual(category.name, args['name'])
